...
-- Стильные цвета
local StyleColors = {
    EnabledColor = Color3.fromRGB(138, 43, 226), -- Фиолетовый как на картинке
    EnabledGlow = Color3.fromRGB(200, 100, 255),
    DisabledColor = Color3.fromRGB(60, 60, 70),
    GlowIntensity = 0.8,
    AnimationSpeed = 0.3
}

-- Функция создания эффекта свечения
