...
-- ПРОСТАЯ ВЕРСИЯ CreateWindow С ВОЛНАМИ
-- Просто замени свою функцию Library:CreateWindow на эту
...
function Library:CreateWindow(...)
    ...
    function Window:AddTab(Name)
        ...
        -- Волна для таба
        local TabWave = { pos = 0, speed = 0.07, width = 3 }
        
        local TabWaveConnection = RunService.Heartbeat:Connect(function()
            if not Outer.Visible or not TabFrame.Visible then return end
        ...
        -- Здесь добавь остальные функции Tab (AddGroupbox, AddLeftGroupbox, AddRightGroupbox, AddTabbox и т.д.)
        -- Копируй их из оригинальной библиотеки
...
print("🌊 CreateWindow с волнами готов!")
print("✨ Заголовок и табы теперь с фиолетовыми волнами")
